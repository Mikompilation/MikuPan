...
signed char AddNewPointLight(sceVu0FVECTOR *pos, sceVu0FVECTOR *diffuse,
                             float *power, u_char room_id);
...
signed char CandleAnmOcc(sceVu0FVECTOR *pos, float r, float g, float b,
                         u_char in_pat, u_char pat, u_char out_pat,
                         u_char room_id);
void PointLightCtrl();
void CandleAnmCtrl();
