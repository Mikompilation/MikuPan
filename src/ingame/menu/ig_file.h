...
void SideBar(u_char hav_now, u_char dsp_max, u_short mov_lng, u_char lst_top,
             u_short chr_top, u_char alp, short int dx, short int dy);
void PageInfo(u_char now, u_char all, short int pos_x, short int pos_y,
              u_char alpha);
