...
u_char* GetSubjectNameAddr(u_short kind, u_short no, u_short show)
{
    ...
    break;
    case 1:
        addr = (int *)MikuPan_GetHostPointer(BASE_ADDRESS + 31 * 4);
        addr = (int *)MikuPan_GetHostPointer(Get4Byte((u_char *)addr) + BASE_ADDRESS + show * 4);
        addr = (int *)MikuPan_GetHostPointer(Get4Byte((u_char *)addr) + BASE_ADDRESS + no * 4);
        addr = (int *)MikuPan_GetHostPointer(Get4Byte((u_char *)addr) + BASE_ADDRESS);

        return (u_char *)addr;
    break;
    case 2:
        addr = (int *)MikuPan_GetHostPointer(BASE_ADDRESS + 31 * 4);
        addr = (int *)MikuPan_GetHostPointer(Get4Byte((u_char *)addr) + BASE_ADDRESS + (show + 5) * 4);
        addr = (int *)MikuPan_GetHostPointer(Get4Byte((u_char *)addr) + BASE_ADDRESS + no * 4);
        addr = (int *)MikuPan_GetHostPointer(Get4Byte((u_char *)addr) + BASE_ADDRESS);
    ...
    case 3:
        addr = (int *)MikuPan_GetHostPointer(BASE_ADDRESS + 31 * 4);
        addr = (int *)MikuPan_GetHostPointer(Get4Byte((u_char *)addr) + BASE_ADDRESS + (show + 10) * 4);
        addr = (int *)MikuPan_GetHostPointer(Get4Byte((u_char *)addr) + BASE_ADDRESS + no * 4);
        addr = (int *)MikuPan_GetHostPointer(Get4Byte((u_char *)addr) + BASE_ADDRESS);
    ...
    break;
    case 4:
        addr = (int *)MikuPan_GetHostPointer(BASE_ADDRESS + 32 * 4);
        addr = (int *)MikuPan_GetHostPointer(Get4Byte((u_char *)addr) + BASE_ADDRESS + no * 4);
        addr = (int *)MikuPan_GetHostPointer(Get4Byte((u_char *)addr) + BASE_ADDRESS);
    ...
    case 5:
        if (no < 0x80) {
            addr = (int *)MikuPan_GetHostPointer(BASE_ADDRESS + 37 * 4);
            addr = (int *)MikuPan_GetHostPointer(Get4Byte((u_char *)addr) + BASE_ADDRESS + no * 4);
            addr = (int *)MikuPan_GetHostPointer(Get4Byte((u_char *)addr) + BASE_ADDRESS);
        }
        else
        {
            addr = (int *)MikuPan_GetHostPointer(BASE_ADDRESS + 38 * 4);
            addr = (int *)MikuPan_GetHostPointer(Get4Byte((u_char *)addr) + BASE_ADDRESS + (no - 0x80) * 4);
            addr = (int *)MikuPan_GetHostPointer(Get4Byte((u_char *)addr) + BASE_ADDRESS);
        }
