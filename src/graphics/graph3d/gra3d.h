...
void TransMyLight(LIGHT_PACK *dest_pack, LIGHT_PACK *light_pack,
                  sceVu0FVECTOR pos);
void CalcReflectLight();
void AppendReflectLight(LIGHT_PACK *light_pack);
void DeleteReflectLight(LIGHT_PACK *light_pack);
void SetMyLightObj(LIGHT_PACK *trans_pack, LIGHT_PACK *light_pack,
                   sceVu0FVECTOR cam_zd, sceVu0FVECTOR pos);
