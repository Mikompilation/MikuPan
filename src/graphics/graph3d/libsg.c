...
void calc_skinned_data(sceVu0FVECTOR *dp, float *_m, float *_n)
{
    ...
    vf13[0] = (m0[0][0] * m[0][0]) + (m0[1][0] * m[0][1]) + (m0[2][0] * m[0][2]) + m0[3][0];
    vf13[1] = (m0[0][1] * m[0][0]) + (m0[1][1] * m[0][1]) + (m0[2][1] * m[0][2]) + m0[3][1];
    vf13[2] = (m0[0][2] * m[0][0]) + (m0[1][2] * m[0][1]) + (m0[2][2] * m[0][2]) + m0[3][2];
    vf13[3] = m[0][3];

    vf14[0] = (m1[0][0] * m[1][0]) + (m1[1][0] * m[1][1]) + (m1[2][0] * m[1][2]) + m1[3][0];
    vf14[1] = (m1[0][1] * m[1][0]) + (m1[1][1] * m[1][1]) + (m1[2][1] * m[1][2]) + m1[3][1];
    vf14[2] = (m1[0][2] * m[1][0]) + (m1[1][2] * m[1][1]) + (m1[2][2] * m[1][2]) + m1[3][2];
    vf14[3] = 1.0f - m[0][3];
    ...
    /// Calculate Normals
    vf13[0] = (m0[0][0] * n[0][0]) + (m0[1][0] * n[0][1]) + (m0[2][0] * n[0][2]);
    vf13[1] = (m0[0][1] * n[0][0]) + (m0[1][1] * n[0][1]) + (m0[2][1] * n[0][2]);
    vf13[2] = (m0[0][2] * n[0][0]) + (m0[1][2] * n[0][1]) + (m0[2][2] * n[0][2]);
    vf13[3] = m[0][3];

    vf14[0] = (m1[0][0] * n[1][0]) + (m1[1][0] * n[1][1]) + (m1[2][0] * n[1][2]);
    vf14[1] = (m1[0][1] * n[1][0]) + (m1[1][1] * n[1][1]) + (m1[2][1] * n[1][2]);
    vf14[2] = (m1[0][2] * n[1][0]) + (m1[1][2] * n[1][1]) + (m1[2][2] * n[1][2]);
    vf14[3] = 1.0f - n[0][3];
