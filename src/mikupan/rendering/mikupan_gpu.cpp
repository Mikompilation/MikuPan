...
static SDL_GPUTransferBuffer* AcquireUploadTransfer(unsigned int size)
{
    ...
    SDL_GPUTransferBufferCreateInfo info = SDL_GPUTransferBufferCreateInfo();
...
{
    SDL_GPUTextureCreateInfo tinfo = SDL_GPUTextureCreateInfo();
    ...
    SDL_GPUSamplerCreateInfo sinfo = SDL_GPUSamplerCreateInfo();
    ...
    SDL_GPUTransferBufferCreateInfo tb = SDL_GPUTransferBufferCreateInfo();
...
{
    SDL_GPUSamplerCreateInfo info = SDL_GPUSamplerCreateInfo();
...
static SDL_GPUGraphicsPipeline* GetPipeline(unsigned int primitive)
{
    ...
    SDL_GPUColorTargetBlendState blend = SDL_GPUColorTargetBlendState();
