...
static float g_title_smoke_width_dp = 520.0f;
static float g_title_smoke_height_dp = 226.0f;
static float g_title_smoke_a_left_dp = -25.0f;
static float g_title_smoke_a_top_dp = -30.0f;
static float g_title_smoke_b_left_dp = -25.0f;
